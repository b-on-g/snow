...
;
	($.$bog_snow) = class $bog_snow extends ($.$mol_plugin) {};
...
(function ($) {
    var $$;
    (function ($$) {
        class $bog_snow extends $.$bog_snow {
            snowflakes_created(next) {
                if (next !== undefined)
                    return next;
                return false;
            }
            render() {
                ...
                if (!ownerEl || !(ownerEl instanceof HTMLElement))
                    return;
        ...
        __decorate([
            $mol_mem
        ], $bog_snow.prototype, "snowflakes_created", null);
        $$.$bog_snow = $bog_snow;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
...
;
	($.$mol_icon_worker) = class $mol_icon_worker extends ($.$mol_icon) {
		path(){
			return "M12,15C7.58,15 4,16.79 4,19V21H20V19C20,16.79 16.42,15 12,15M8,9C8,11.21 9.79,13 12,13C14.21,13 16,11.21 16,9M11.5,2C11.2,2 11,2.21 11,2.5V5.5H10V3C10,3 7.75,3.86 7.75,6.75C7.75,6.75 7,6.89 7,8H17C16.95,6.89 16.25,6.75 16.25,6.75C16.25,3.86 14,3 14,3V5.5H13V2.5C13,2.21 12.81,2 12.5,2H11.5Z";
		}
	};
...
;
	($.$bog_snow_demo) = class $bog_snow_demo extends ($.$mol_page) {
		Theme_lights(){
			const obj = new this.$.$mol_lights_toggle();
			return obj;
		}
		icon(){
			const obj = new this.$.$mol_icon_worker();
			return obj;
		}
		Favicon(){
		...
		Welcome(){
			const obj = new this.$.$mol_paragraph();
			(obj.title) = () => ((this.$.$mol_locale.text("$bog_snow_demo_Welcome_title")));
			return obj;
		}
		Feature1(){
			const obj = new this.$.$mol_paragraph();
			(obj.title) = () => ((this.$.$mol_locale.text("$bog_snow_demo_Feature1_title")));
			return obj;
		}
		Feature2(){
			const obj = new this.$.$mol_paragraph();
			(obj.title) = () => ((this.$.$mol_locale.text("$bog_snow_demo_Feature2_title")));
			return obj;
		}
		Feature3(){
			const obj = new this.$.$mol_paragraph();
			(obj.title) = () => ((this.$.$mol_locale.text("$bog_snow_demo_Feature3_title")));
			return obj;
		}
		Feature4(){
			const obj = new this.$.$mol_paragraph();
			(obj.title) = () => ((this.$.$mol_locale.text("$bog_snow_demo_Feature4_title")));
			return obj;
		}
		Feature5(){
			const obj = new this.$.$mol_paragraph();
			(obj.title) = () => ((this.$.$mol_locale.text("$bog_snow_demo_Feature5_title")));
			return obj;
		}
		Feature6(){
			const obj = new this.$.$mol_paragraph();
			(obj.title) = () => ((this.$.$mol_locale.text("$bog_snow_demo_Feature6_title")));
			return obj;
		}
		Feature7(){
			const obj = new this.$.$mol_paragraph();
			(obj.title) = () => ((this.$.$mol_locale.text("$bog_snow_demo_Feature7_title")));
			return obj;
		}
		Feature8(){
			const obj = new this.$.$mol_paragraph();
			(obj.title) = () => ((this.$.$mol_locale.text("$bog_snow_demo_Feature8_title")));
			return obj;
		}
		Feature9(){
			const obj = new this.$.$mol_paragraph();
			(obj.title) = () => ((this.$.$mol_locale.text("$bog_snow_demo_Feature9_title")));
			return obj;
		}
		Features_list(){
			const obj = new this.$.$mol_list();
		...
		Features(){
			...
			(obj.title) = () => ((this.$.$mol_locale.text("$bog_snow_demo_Features_title")));
			(obj.content) = () => ([(this.Features_list())]);
			return obj;
		}
		code_example(){
			return (this.$.$mol_locale.text("$bog_snow_demo_code_example"));
		}
		Code_example(){
			const obj = new this.$.$mol_textarea();
			(obj.value) = () => ((this.code_example()));
			return obj;
		}
		Usage(){
			const obj = new this.$.$mol_section();
			(obj.title) = () => ((this.$.$mol_locale.text("$bog_snow_demo_Usage_title")));
			(obj.content) = () => ([(this.Code_example())]);
			return obj;
		}
		Note(){
			const obj = new this.$.$mol_paragraph();
			(obj.title) = () => ((this.$.$mol_locale.text("$bog_snow_demo_Note_title")));
			return obj;
		}
		Scroll(){
			const obj = new this.$.$mol_paragraph();
			(obj.title) = () => ((this.$.$mol_locale.text("$bog_snow_demo_Scroll_title")));
			return obj;
		}
		Spacer(){
			const obj = new this.$.$mol_view();
		...
		title(){
			return (this.$.$mol_locale.text("$bog_snow_demo_title"));
		}
		tools(){
			return [(this.Theme_lights())];
		}
		plugins(){
			return [
				(this.Favicon()), 
	...
	($mol_mem(($.$bog_snow_demo.prototype), "Theme_lights"));
	($mol_mem(($.$bog_snow_demo.prototype), "icon"));
	($mol_mem(($.$bog_snow_demo.prototype), "Favicon"));
	($mol_mem(($.$bog_snow_demo.prototype), "Snow"));
	($mol_mem(($.$bog_snow_demo.prototype), "Theme"));
	($mol_mem(($.$bog_snow_demo.prototype), "Welcome"));
	($mol_mem(($.$bog_snow_demo.prototype), "Feature1"));
	($mol_mem(($.$bog_snow_demo.prototype), "Feature2"));
	($mol_mem(($.$bog_snow_demo.prototype), "Feature3"));
	($mol_mem(($.$bog_snow_demo.prototype), "Feature4"));
	($mol_mem(($.$bog_snow_demo.prototype), "Feature5"));
	($mol_mem(($.$bog_snow_demo.prototype), "Feature6"));
	($mol_mem(($.$bog_snow_demo.prototype), "Feature7"));
	($mol_mem(($.$bog_snow_demo.prototype), "Feature8"));
	($mol_mem(($.$bog_snow_demo.prototype), "Feature9"));
	($mol_mem(($.$bog_snow_demo.prototype), "Features_list"));
	($mol_mem(($.$bog_snow_demo.prototype), "Features"));
	($mol_mem(($.$bog_snow_demo.prototype), "Code_example"));
	($mol_mem(($.$bog_snow_demo.prototype), "Usage"));
	($mol_mem(($.$bog_snow_demo.prototype), "Note"));
	($mol_mem(($.$bog_snow_demo.prototype), "Scroll"));
	($mol_mem(($.$bog_snow_demo.prototype), "Spacer"));
